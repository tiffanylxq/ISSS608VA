...
For this exercise, we have selected ID xx & Xx and only look at 3 different dates (16 May 2022, 20 May 2022, 21 May 2022) of the 15 month period to see their daily routine on a Monday, Friday and Saturday.
...
P180f<- P180b %>%
  filter(date=="16.05.2022"| date=="20.05.2022"| date=="21.05.2022")
...
saveRDS(P180, 'data/ActivityLogs/P180')
P180 <- readRDS('data/ActivityLogs/P180')
head(P180)

saveRDS(P1000, 'data/ActivityLogs/P1000')
P1000 <- readRDS('data/ActivityLogs/P1000')
head(P1000)
